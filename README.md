...
MailHog has been set up for TYPO3 CMS. For Neos, you may be interested in the [Langeland.SwiftBox](https://github.com/langeland/Langeland.SwiftBox) package. It is a package that can override the swiftmailer setting to send to that instead and you can browse all the emails with the included flow application.
